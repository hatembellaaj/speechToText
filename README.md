...
- ⚙️ Architecture **séparée frontend/backend**
  - Backend Flask → port `5020`
  - Frontend Nginx → port `8020`
...
- **Frontend (page web)** → [http://127.0.0.1:8020](http://127.0.0.1:8020)  
- **Backend API (Flask)** → [http://127.0.0.1:5020/transcribe](http://127.0.0.1:5020/transcribe)

---

## 🧠 Utilisation

1. Ouvrez [http://127.0.0.1:8020](http://127.0.0.1:8020)
...
|----------|-------------|-------------|
| Flask Backend | `5020` | API `/transcribe` |
| Nginx Frontend | `8020` | Interface web utilisateur |
